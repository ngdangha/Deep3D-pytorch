...
def get_data_path(root='examples'):
    ...
    im_path = [os.path.join(root, i) for i in sorted(os.listdir(root)) if i.endswith('png') or i.endswith('jpg') or i.endswith('PNG') or i.endswith('JPG')]
...
def main(rank, opt, name='examples'):
    ...
    for i in range(len(im_path)):
        ...
        model.save_mesh(os.path.join(output_path, img_name+'.obj')) # save reconstruction meshes
